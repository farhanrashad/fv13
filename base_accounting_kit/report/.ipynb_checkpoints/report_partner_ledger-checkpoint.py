...
class ReportPartnerLedger(models.AbstractModel):
    ...
    def _lines(self, data, partner):
        ...
        params = [partner.id, tuple(data['computed']['move_state']),
                 ...
                 query_get_data[2]
        query = """
            SELECT "account_move_line".id, "account_move_line".date, j.code, acc.code as a_code, acc.name as a_name, "account_move_line".ref, m.name as move_name, "account_move_line".name, "account_move_line".debit, "account_move_line".credit, "account_move_line".balance,"account_move_line".amount_currency,"account_move_line".currency_id, c.symbol AS currency_code
